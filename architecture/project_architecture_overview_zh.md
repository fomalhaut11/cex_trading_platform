...
需要快速接手当前任务时，应先阅读仓库根目录的 `START_HERE.md`；本文用于
进一步理解完整架构。
...
| 当前 BTC Funding Carry 快速上线顺序 | `development/funding_carry_fast_track_plan.md` |
| Post-MVP 平台交付方向 | `development/platform_delivery_plan.md` |
