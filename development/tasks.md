...
| T040 | Authoritative latest Funding market-state view and Snapshot source contract | Complete | ADR-014, T003-T005, T026 |
| T041 | Carry identifiers, pair, position and ownership contracts | Complete | ADR-014, T027, T036 |
...
| T046 | Mode-neutral offline execution runtime and deterministic fault harness | Complete | T045 |
...
ADR-014 is Accepted and T040-T044/A017 credential-free offline implementation
is complete. The implementation adds authoritative Funding state, typed Carry
contracts and Snapshots, pure economic policy, a durable application aggregate,
